...
class SensorCalibDrawingWidgetPlot : public SensorCalibDrawingWidget {
protected:
...
public:
  int user;
  double *plotValue;
  helium::Array<double,experiment::USR>* plotPie;
  SensorCalibDrawingWidgetPlot(cfg::guide::Sensors &sensors,cfg::guide::SensorGui &sensorGui,cfg::guide::Colors &pcolors,helium::ValueHub<int>& pas): 
    SensorCalibDrawingWidget(sensors,sensorGui,pcolors,pas),
    plotValue(NULL),plotPie(NULL)
  {
    user = 0;
  }
